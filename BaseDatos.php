<?php
	...
	class Database{
		...
		public function create($NombreE,$CostoEestudiante,$CostoEparticular,$FechaEinicio,$FechaEfinal,$HoraEinicio,$HoraEfinal,$ResponsableE,$OrganizadoresE,$DescripcionE){
			$sql = "INSERT INTO `eventos` (NombreE, CostoEestudiante, CostoEparticular, FechaEinicio, FechaEfinal, HoraEinicio, HoraEfinal, ResponsableE, OrganizadoresE, DescripcionE) VALUES ('$NombreE','$CostoEestudiante','$CostoEparticular','$FechaEinicio','$FechaEfinal','$HoraEinicio','$HoraEfinal','$ResponsableE','$OrganizadoresE','$DescripcionE')";
